...
public class CashCardController {
    ...
    @PostMapping
    private ResponseEntity<Void> createCashCard(@RequestBody CashCard newCashCardRequest, UriComponentsBuilder ubc, Principal principal) {
    ...
    private ResponseEntity<Void> putCashCard(@RequestBody CashCard newCashCardRequest, Principal principal) {
        CashCard cashCard = findCashCard(newCashCardRequest.id(), principal);
        if (cashCard != null) {
